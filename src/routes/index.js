...
import UserTableUnverified from "../pages/User/userTableUnverified";
...
const authProtectedRoutes = [
  ...
  { path: "/userTableUnver", component: UserTableUnverified },
  { path: "/profile/:id", component: profile },
  { path: "/userDetails/:id/status", component: userDetails },
  { path: "/addStocks", component: AddStocks },
