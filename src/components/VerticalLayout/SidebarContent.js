          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="userTable">{this.props.t("Verified User")}</Link>
                </li>
                <li>
                  <Link to="userTableUnver">
                    {this.props.t("Unverified User")}
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              <Link to="/addStocks" className="waves-effect">
                <i className="ri-dashboard-line"></i>
                <span className="ml-1">{this.props.t("Add stocks")}</span>
              </Link>
            </li>

            <li>
              <Link to="/userTable" className="waves-effect">
                <i className="ri-dashboard-line"></i>
                <span className="ml-1">{this.props.t("Generate Bill")}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/userTable" className="waves-effect">
                <i className="ri-dashboard-line"></i>
                <span className="ml-1">{this.props.t("Constants Tab")}</span>
              </Link>
            </li>
            ...
            <li>
              <Link to="/userTable" className="waves-effect">
                <i className="ri-dashboard-line"></i>
                <span className="ml-1">{this.props.t("Suggested Stocks")}</span>
              </Link>
            </li>
